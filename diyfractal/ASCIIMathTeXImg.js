var AMTcgiloc = 'http://www.imathas.com/cgi-bin/mimetex.cgi'; //wtf
...
function initTex2Asciimath(givenAMsymbols) {
var config = {
...
var AMsymbols = (givenAMsymbols||[]).concat([
//some greek symbols
...
//{input:"abs",   tag:"mo", output:"abs",  tex:null, ttype:UNARY,func:true},// notexcopy:true, rewriteleftright:["|","|"]},
//{input:"norm",   tag:"mo", output:"norm",  tex:null, ttype:UNARY,func:true},//, notexcopy:true, rewriteleftright:["\\|","\\|"]},
